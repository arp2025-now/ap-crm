...
import { PRODUCT_DEFAULT_FIELD_DEFINITIONS } from "@/lib/product-field-definitions";

const STORAGE_KEY = "crm-product-fields";

export function useProductFields() {
  const [fields, setFields] = useState<FieldDefinition[]>(PRODUCT_DEFAULT_FIELD_DEFINITIONS);
