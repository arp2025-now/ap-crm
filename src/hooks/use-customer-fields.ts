...
import { CUSTOMER_DEFAULT_FIELD_DEFINITIONS } from "@/lib/customer-field-definitions";

const STORAGE_KEY = "crm-customer-fields";

export function useCustomerFields() {
  const [fields, setFields] = useState<FieldDefinition[]>(CUSTOMER_DEFAULT_FIELD_DEFINITIONS);
